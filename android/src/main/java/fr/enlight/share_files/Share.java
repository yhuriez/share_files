...
package fr.enlight.share_files;
...
class Share {
  ...
  void shareFiles(List<String> paths, List<String> mimeTypes, String text, String subject, String email, String phoneNumber)
      throws IOException {
    ...
    if (phoneNumber != null) shareIntent.putExtra("address", phoneNumber);
  ...
  private File getShareCacheFolder() {
    return new File(getContext().getCacheDir(), "share_files");
  }
